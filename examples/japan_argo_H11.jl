...
te = DateTime(2000, 1, 1) .+ Millisecond.(h5read("results/anomalies/japan_H11N3_x2y_16ex.h5", "t"))
m = length(te)
...
# constrian argo data manually
t0,t1,y0,z0 = DateTime(2007,7,1),DateTime(2022,2,1),30,-1.9e3
...
Pa,xa,Pt,xt,Pat,xat,C0,dC = SOT.invertargot0(te,azme,x,3.7σtrend, σannual, σsemiannual,tpairs,ppairs,tstation,evtpos,pstations,nearfloats,itp_c,itp_ca,itp_tc,itp_tca)
...
# save to file
h5open("results/argo/argotri_H11.h5", "w") do file
  write(file, "τa", τa)
  write(file, "τt", τt)
  write(file, "τat", τat)
  write(file, "ea", ea)
