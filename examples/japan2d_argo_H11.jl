...
tstart,tstep,tend = DateTime(2008, 1, 1),Day(10),DateTime(2021, 7, 31)
...
h5fl = "results/anomalies/japan_H11N3_x2y_16ex.h5"
...
#Pa,xa,Pt,xt,Pat,xat = SOT.invertargot2d(te,x,σtrend, σannual, σsemiannual,tpairs,ppairs,tstation,evtpos,pstations,floats,λx,σs,σn,nxk,itp_c,itp_ca,itp_c2d,itp_ca2d,c2d;full=true)
...
h5open(@sprintf("results/argo/point_H11_2d%s.h5",shape), "w") do file
  write(file, "xa", xa)
  write(file, "xt", xt)
  write(file, "xat", xat)
  write(file, "Pa", Pa)
